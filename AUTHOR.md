...
## QUALIFICATIONS
   ...
   * **Programmer** – Perl (mod_perl, Template Toolkit, emb_perl, etc), HTML 5, CSS, Javascript (Ajax, jQuery, Prototype, etc), Bash/C-Shell, eZ80 Assembler, Z80 Assembler, (some) PHP, and I can modify and debug C/C# for simple code adjustments.  My specialty is code and process optimization and parallelism in Perl.
   * **Internet** – Linux Server Administration, Apache, IIS, SOAP, REST, TCP/IP, MySQL, some Oracle, Infrastructure, Solutions Implementation.
   * **Operating Systems** – Linux (RedHat, Fedora, Ubuntu, Debian & SUSE), Windows (all versions), True-64 Unix, Apple OS-X, FreeBSD, Solaris.
   * **Graphics** – Photoshop, Lightwave 3D, Adobe Premiere, Gimp, ImageMagik, Framebuffer
   * **Hardware** – Server & Workstation assembly and troubleshooting. PC, Mac, Sun, HP, Dell, and Compaq to name a few.  Electronics knowledge and experience.
   * **Tools** – AI, Nagios, EditPad, ClearCase, GIT, Perforce, Reviewboard, Electric Commander, configuration management, and more.
...
### Estee Lauder (Contracted via Cognizant)
   ...
   * Resolved complex Linux server issues, enhancing system reliability and performance.
...
### CargoTel
   ...
   * Manage, update, install and configure various Linux services, including Apache, Nagios, and Nginx..
   * Write technical documentation for department staff.
...
### Broadcom Inc. (Contracted via Apex Systems)
   ...
   * Specialized in code optimization and parallelism.
   * Utilized Perl, PHP, HTML, CSS, Javascript, MySQL, XML, REST and Bash.  Apache, Linux and Windows with Cygwin, ActivePerl or Strawberry Perl were usually the environment.
...
### E.F. Johnson Technologies (Contracted via Digital Systems)
   ...
   * Utilized HTML, CSS, Apache, Javascript with Prototype, Ajax and Perl together as a unit for the NMS as it is a web based GUI.  SOAP, XML, C#, and Oracle were some of the technologies utilized.
...
### Retired.com
   ...
   * Enhanced user experience, leading to increased traffic and engagement on the platform.
...
### United States Navy (METOC Services, North Island Naval Air Station)
   ...
   * Ensured high-security measures were implemented, safeguarding sensitive information.
...
### LPL Financial Services
   ...
   * Collaborated with cross-functional teams to ensure seamless integration of applications improving the user experience.
   * Redesigned the entire DNS infrstructure for improved speed, security and overall response.
