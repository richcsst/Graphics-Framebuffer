...
- **acceleration**, **active\_console**, **add\_mode**, **alpha\_mode**, **and\_mode**, **angle\_line**, **arc**, **attribute\_reset**
...
- **ellipse**
- **fill**, **filled\_pie**
- **get\_face\_name**, **get\_font\_list**, **getpixel**, **get\_pixel**, **graphics\_mode**
- **hardware**
- **last\_plot**, **line**, **load\_image**
- **mask\_mode**, **monochrome**, **multiply\_mode**
- **new**, **normal\_mode**
- **or\_mode**
- **perl**, **pixel**, **play\_animation**, **plot**, **poly\_arc**, **polygon**
- **rbox**, **rounded\_box**, **replace\_color**, **RGB565\_to\_RGB888**, **RGB565\_to\_RGBA8888**, **RGB888\_to\_RGB565**, **RGB888\_to\_RGBA8888**, **RGBA8888\_to\_RGB565**, **RGBA8888\_to\_RGB888**
- **screen\_dimensions**, **screen\_dump**, **set\_b\_color**, **setbcolor**, **set\_background\_color**, **setcolor**, **set\_color**, **set\_foreground\_color**, **setpixel**, **set\_pixel**, **software**, **subtract\_mode**
- **text\_mode**, **ttf\_paragraph**, **ttf\_print**
- **unmask\_mode**
- **vsync**
- **wait\_for\_console**, **which\_console**
- **xor\_mode**
