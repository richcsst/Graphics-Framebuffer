...
## Example File Descriptions
   ...
   | **text_mode.pl** | Maybe your script crashed, and the cursor is not responding.  Hit [ENTER] then blindly run this to fix the screen and restore text mode.<br><br> *Note, I highly suggest not using graphics mode while developing your code.  It will still show you graphics output, but if your code crashes, you can still use the cursor.* |
