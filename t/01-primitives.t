...
diag("Please be patient, gathering images...");
$| = 1;
...
my $DORKSMILE;
diag('Please be patient, loading Images...');
my $logo = $F->load_image(
    {
        'x'      => 0,
        'y'      => 0,
        'width'  => $XX,
		...
		my $b = $F->ttf_print(
			{
				...
				'height'       => max(9,  20 * $ym),
				'wscale'       => 1.25,
				'text'         => "Please be patient, loading Images... $file",
				'bounding_box' => 1,
				'antialias'    => 0,
                'color'        => 'FFFFFFFF',
			}
